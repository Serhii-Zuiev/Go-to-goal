...
const NewGoal = () => {
  ...
  return (
    ...
    <div className={styles.new_goal_section}>
      ...
      {goals.length > 0 && < GoalCard title={goals[0].title} points={goals[0].points} goalId={goals[0]._id}/>}
        {goals.length === 0 && <button type="button" className={styles.button} onClick={()=> setIsModalOpen(true)}>
        ...
        {goals.length === 0 && <div className={styles.new_goal_info}>   
